...
def main() -> int:
    checks = {
        ...
        ROOT / ".github/workflows/ci-engine.yml": [
            ...
            'required-marker "[IMM_UNITY_VK_CAMERA_TARGET_COMMAND_20260731]"',
            'required-marker "[IMM_UNITY_VK_CAMERA_TARGET_PRESENTED_20260731]"',
        ...
        ROOT / "code/ImmUnitySampleProject/Packages/com.immersive-foundation.imm-unity/Runtime/ImmPlayerManager.cs": [
            ...
            "[IMM_UNITY_VK_CAMERA_TARGET_COMMAND_20260731]",
