...
def main() -> int:
    checks = {
        ...
        ROOT / ".github/workflows/ci-engine.yml": [
            ...
            'required-marker "[IMM_UNITY_VK_UPLOAD_CB_20260730]"',
            'required-marker "[IMM_UNITY_VK_HOST_RT_20260612]"',
            'required-marker "Unity Vulkan host render:"',
            ...
            'required-marker "[IMM_UNITY_SMOKE] render source=unity-vulkan-active-render-pass"',
