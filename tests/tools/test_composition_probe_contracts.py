...
def main() -> int:
    checks = {
        ...
        ROOT / ".github/workflows/ci-engine.yml": [
            ...
            'required-marker "commandBuffer=False cameraCallback=True"',
            ...
            'required-marker "[IMM_UNITY_VK_PRESENT_BACKBUFFER_20260731]"',
            'required-marker "ordering=present-before-native"',
            'required-marker "[IMM_UNITY_VK_STABLE_CROSS_FRAME_20260731]"',
            'required-marker "[IMM_UNITY_VK_MANUAL_QUAD_SETUP_20260731]"',
            'required-marker "shader=Hidden/IMM/VulkanPresent"',
            'required-marker "[IMM_UNITY_VK_MANUAL_QUAD_PRESENTED_20260731]"',
            'required-marker "explicitUvs=True"',
            'required-marker "[IMM_UNITY_VK_SURFACE_PROBE_20260731] active=True"',
            'required-marker "[IMM_UNITY_VK_SURFACE_PROBE_HOLD_20260731]"',
            ...
            "--required-capture-name unity-android-vulkan-presented.png",
        ...
        ROOT / "code/ImmUnitySampleProject/Packages/com.immersive-foundation.imm-unity/Runtime/ImmPlayerManager.cs": [
            ...
            "[IMM_UNITY_VK_STABLE_CROSS_FRAME_20260731]",
            "[IMM_UNITY_VK_MANUAL_QUAD_SETUP_20260731]",
            "[IMM_UNITY_VK_MANUAL_QUAD_PRESENTED_20260731]",
            "[IMM_UNITY_VK_SURFACE_PROBE_20260731]",
            "mode=manual-textured-quad",
            "ordering=present-before-native",
            "Graphics.SetRenderTarget((RenderTexture)null)",
            "GL.TexCoord2(1.0f, 1.0f)",
            "submission=completed-source-to-unity-target",
