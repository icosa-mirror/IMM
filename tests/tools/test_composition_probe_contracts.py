...
def main() -> int:
    checks = {
        ...
        ROOT / ".github/workflows/ci-engine.yml": [
            ...
            'required-marker "[IMM_UNITY_VK_TRUE_BACKBUFFER_SETUP_20260731]"',
            'required-marker "[IMM_UNITY_VK_TRUE_BACKBUFFER_BLIT_20260731]"',
            'required-marker "mainTargetClearedDuringBlit=True"',
        ...
        ROOT / "code/ImmUnitySampleProject/Packages/com.immersive-foundation.imm-unity/Runtime/ImmPlayerManager.cs": [
            ...
            "[IMM_UNITY_VK_TRUE_BACKBUFFER_SETUP_20260731]",
