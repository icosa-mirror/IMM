...
REQUIRED_JOBS = {
    ...
    ".github/workflows/ci-device.yml": {
        ...
        "android-godot-vulkan": ["Check Firebase Test Lab configuration", "Build Android Godot APK", "Build Android Godot Firebase instrumentation APK", "Run Android Godot Vulkan smoke in Firebase Test Lab", "Record Android Godot Vulkan screenshot metrics", "Write Android Godot Vulkan screenshot report", "Write CI manifest", "Collect artifact summary"],
