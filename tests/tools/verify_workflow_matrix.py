...
REQUIRED_JOBS = {
    ...
    ".github/workflows/ci-gpu.yml": {
        ...
        "macos-godot-metal": ["Preflight Godot Metal runner", "Download macOS Godot extension build artifact", "Stage macOS Godot extension build artifact", "Run Godot Metal visual smoke", "Record Godot Metal render metrics", "Classify Godot Metal visual evidence", "Write Godot Metal render report", "Write Godot Metal composition report", "Write CI manifest", "Collect artifact summary"],
