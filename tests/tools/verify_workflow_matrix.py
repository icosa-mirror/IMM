...
REQUIRED_JOBS = {
    ...
    ".github/workflows/ci-engine.yml": {
        ...
        "unity-windows-vulkan-synthetic-stereo": ["Install Mesa lavapipe", "Configure Mesa lavapipe Vulkan ICD", "Preflight hosted Unity Vulkan stereo runner", "Run Unity Vulkan synthetic stereo smoke", "Split and verify stereo visual evidence", "Verify Unity Vulkan synthetic stereo log contract", "Stage Unity Vulkan synthetic stereo capture evidence", "Write CI manifest", "Collect artifact summary", "Upload Unity Vulkan synthetic stereo artifacts"],
