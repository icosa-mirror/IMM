...
def main() -> int:
    ...
    run(
        [
            ...
            "-Ithirdparty/ogg/libvorbis-1.3.7/include",
            "-Ithirdparty/ogg/libvorbis-1.3.7/include/vorbis",
            "-Ithirdparty/ogg/libvorbis-1.3.7/lib",
            "-Ithirdparty/libpng-1.6.58",
