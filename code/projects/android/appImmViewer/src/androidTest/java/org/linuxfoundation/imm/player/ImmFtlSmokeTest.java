...
public final class ImmFtlSmokeTest {
    ...
    public void rendersSampleFrame() throws Exception {
        ...
        requireMarker(logcat, "revision=5 status=4 result=0 canonicalChanged=1 overridePreserved=1 effectivePreserved=1 canonicalOpacityChanged=1 opacityOverridePreserved=1 opacityEffectivePreserved=1");
        ...
        requireMarker(faceLogcat, "revision=5 status=4 result=0 canonicalChanged=1 overridePreserved=1 effectivePreserved=1 canonicalOpacityChanged=1 opacityOverridePreserved=1 opacityEffectivePreserved=1");
