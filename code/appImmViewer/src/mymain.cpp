...
//
// IMM_VIEWER_LIVE_EDIT=<frame> applies one geometry edit to the first paint layer's first
// drawing at that frame, through the same API an editor uses, and logs what each step cost.
